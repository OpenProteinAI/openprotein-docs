...
export function Hero() {
  return (
    <section className="pt-13 pb-2">
      <h1 className="mb-4.5 text-4xl leading-tight font-bold tracking-[-1px] text-fd-foreground">
        Data-Driven Protein Engineering
      </h1>
      <p className="mb-4 max-w-[130ch] text-base leading-relaxed text-pretty text-fd-foreground">
      ...
      <p className="mb-8 max-w-[130ch] text-base leading-relaxed text-pretty text-fd-foreground">
      ...
      <div className="flex flex-wrap items-center gap-x-6 gap-y-4 rounded-[0.75em] border border-fd-border bg-fd-card px-7 py-6">
