...
export function Hero() {
  return (
    <section className="pt-16 pb-2 text-center">
      ...
      <p className="mx-auto mb-4 max-w-4xl text-base leading-relaxed text-pretty text-fd-foreground">
      ...
      <p className="mx-auto mb-9 max-w-4xl text-base leading-relaxed text-pretty text-fd-muted-foreground">
      ...
      <div className="flex flex-col items-center gap-4 rounded-[0.75em] border border-fd-border bg-fd-card px-7 py-6">
        ...
        <div className="text-base text-fd-muted-foreground">Learn more about our tools →</div>
