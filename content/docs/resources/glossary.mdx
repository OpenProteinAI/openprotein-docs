...
| Term | Definition |
| --- | --- |
| UMAP | Uniform Manifold Approximation and Projection (UMAP) is a dimension reduction technique that can be used for visualisation similarly to t-SNE, and also for general nonlinear dimension reduction. Read more [here](https://umap-learn.readthedocs.io/en/latest/). |
