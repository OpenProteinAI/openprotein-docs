---
title: Models
description: The Models API is a single, consistent way to call any model on the platform and to discover what each model can do.
openapi: models
---
It unifies foundation models, property predictors, structure predictors, and structure/sequence generators behind one namespace.
