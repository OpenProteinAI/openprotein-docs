---
title: Nanobody binder design with BoltzGen using the GUI
description: Designing de novo nanobody binders to PDL1 using BoltzGen and ProteinMPNN with the web interface
---
...
- **Structure Generation**: Generate plausible structures for the nanobody binder CDRs using
  **BoltzGen** ([Stark et al., 2025](https://www.biorxiv.org/content/10.1101/2025.11.20.689494v1)),
...
- **Sequence Design**: Design sequences for the generated CDRs using **ProteinMPNN**
  ([Dauparas et al., 2022](https://doi.org/10.1126/science.add2187)), an inverse folding model
...
- **In Silico Validation**: Validate the designs by predicting their structures with **Boltz-2**
  ([Passaro et al., 2025](https://www.biorxiv.org/content/10.1101/2025.06.14.659707v1)) and
...
([Stark et al., 2025](https://www.biorxiv.org/content/10.1101/2025.11.20.689494v1)).
...
<Callout type="info">
  ...
  [Learn more about PoET-2](https://www.openprotein.ai/a-multimodal-foundation-model-for-controllable-protein-generation-and-representation-learning).
</Callout>
...
<Figure src="/_static/walkthroughs/nanobody/pdl1-1.png" align="center" />

<Figure src="/_static/walkthroughs/nanobody/pdl1-2.png" align="center" />

- Click **Upload files** and upload `7UXQ.cif`
  ([PDB: 7UXQ](https://www.rcsb.org/structure/7UXQ)). The sequence and structure will appear
  in the sequence component.

Remove **chain C** by clicking the **×** button.

<Figure src="/_static/walkthroughs/nanobody/pdl1-3.png" align="center" />
...
<Figure src="/_static/walkthroughs/nanobody/pdl1-4.png" align="center" />

### Step 1.2: Define the nanobody scaffold

We will use the structure from [PDB: 7EOW](https://www.rcsb.org/structure/7EOW) as our scaffold.
...
<Figure src="/_static/walkthroughs/nanobody/pdl1-5.png" align="center" />

- Remove **chain A**, keeping only chain B.

<Figure src="/_static/walkthroughs/nanobody/pdl1-6.png" align="center" />
...
<Figure src="/_static/walkthroughs/nanobody/pdl1-7.png" align="center" />
...
<Figure src="/_static/walkthroughs/nanobody/pdl1-8.png" align="center" />
...
<Figure src="/_static/walkthroughs/nanobody/pdl1-9.png" align="center" />
...
<Figure src="/_static/walkthroughs/nanobody/pdl1-10.png" align="center" />
...
<Figure src="/_static/walkthroughs/nanobody/pdl1-11.png" align="center" />
...
[RFdiffusion binder design tutorial](/walkthroughs/Protein_protein_binder_design_with_RFdiffusion#design-sequences-with-proteinmpnn).
...
<Figure src="/_static/walkthroughs/nanobody/pdl1-12.png" align="center" />
...
We also retrieve the [predicted aligned error (PAE)](https://www.ebi.ac.uk/training/online/courses/alphafold/inputs-and-outputs/evaluating-alphafolds-predicted-structures-using-confidence-scores/pae-a-measure-of-global-confidence-in-alphafold-predictions/)
for each design — a confidence metric that has proven
[highly effective at identifying successful binders](https://www.nature.com/articles/s41467-023-38328-5)
...
([Watson et al., 2023](https://www.nature.com/articles/s41586-023-06415-8)) and BoltzGen studies.
...
| **Binder RMSD** | Measures how closely the predicted structure of *just the binder*<br />matches the generated structure. | \< 1.0 Å |
...
<Figure src="/_static/walkthroughs/nanobody/pdl1-13.png" align="center" />
...
- [Designing miniprotein binders with RFdiffusion](/walkthroughs/Protein_protein_binder_design_with_RFdiffusion)
- [Inverse folding for protein redesign](/walkthroughs/PoET-2_inverse_folding)
- [Antibody lead optimization](/walkthroughs/antibody-engineering)

Or see the detailed API references:

- [BoltzGen](/python-api/api-reference/models#boltzgen)
...
- [PoET-2](/python-api/api-reference/embedding#openprotein.embeddings.PoET2Model)
