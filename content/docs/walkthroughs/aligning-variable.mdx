---
title: Aligning variable length sequences using Python
description: This walkthrough demonstrates how to convert a dataset of unaligned sequences into a dataset of aligned sequences using a Python script.
---
...
<Callout type="info">
  You'll need to install either [conda](https://conda.io/projects/conda/en/latest/user-guide/install/index.html) or [mamba](https://mamba.readthedocs.io/en/latest/installation/mamba-installation.html).
