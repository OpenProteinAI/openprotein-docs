...
dataset. For instructions on how to upload your data, see  [Uploading your data](/web-app/opmodels/uploading-your-data). You will also need a model that has been trained on this dataset. Visit [Model training and evaluation](/web-app/opmodels/model-train-evaluate) for instructions on how to do this.

If you don't yet have experimental data, start with our [PoET tools](/web-app/poet).
...
<Figure src="/_static/opmodels/design/create-design.png" />
...
<Figure src="/_static/opmodels/design/design-criteria.png" />
...
<Accordions>
  <Accordion title="Instructions for using design constraints">
    ...
    <Figure src="/_static/opmodels/design/design-constraints-rules.png" />
...
<Figure src="/_static/opmodels/design/summary-plot-1.png" />
...
<Figure src="/_static/opmodels/design/summary-plot-2.png" />
...
<Figure src="/_static/opmodels/design/summary-plot-3.png" />
...
<Figure src="/_static/opmodels/design/summary-plot-4.png" />
...
<Figure src="/_static/opmodels/design/summary-plot-5.png" />
...
<Figure src="/_static/opmodels/design/summary-plot-6.png" />
...
<Figure src="/_static/opmodels/design/summary-plot-7.png" />
...
<Figure src="/_static/opmodels/design/design-UMAP.png" />
...
<Figure src="/_static/opmodels/design/design-histogram.png" />
...
<Figure src="/_static/opmodels/design/design-joint-plot.png" />
...
Explore your sequence's 3D structure with the [Structure Prediction](/web-app/structure-prediction/using-structure-prediction) tool, or use [Substitution Analysis](/web-app/opmodels/sub-analysis) to evaluate the single substitution variants of your sequence.
