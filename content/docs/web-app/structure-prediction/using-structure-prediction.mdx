...
description: This tutorial shows you how to use the Structure Prediction tool to visualize the 3D structures of your protein sequences using our web app.
---
...
Structure prediction can also be accessed via the [REST API](/rest-api/fold) or our [Python client](/python-api/api-reference/fold).
...
<Figure src="/_static/structure-prediction/AlphaFold2.png" alt="AlphaFold2" />
...
<Figure src="/_static/structure-prediction/boltz.png" alt="Boltz-1 and Boltz-2" />
...
<Figure src="/_static/structure-prediction/ESMFold.png" alt="ESMFold" />
...
<Figure src="/_static/structure-prediction/esmfold2.png" alt="ESMFold2" />
...
<Figure src="/_static/structure-prediction/minifold.png" alt="MiniFold" />
...
<Figure src="/_static/structure-prediction/rosettafold.png" alt="RosettaFold-3" />
...
<Figure src="/_static/structure-prediction/protenix.png" alt="Protenix" />
...
<Figure src="/_static/structure-prediction/molstar-vis.png" alt="Molstar Visualization" />
...
<Figure src="/_static/structure-prediction/compare-struc-add.png" alt="Adding Structures to Mol*" />
...
<Figure src="/_static/structure-prediction/compare-struc-icon.png" alt="Hiding/deleting Structures from Mol*" />
