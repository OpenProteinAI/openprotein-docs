---
title: Using the Indel Analysis tool
description: The Indel Analysis tool enables you to evaluate the impact of insertions and deletions (indels) at any position within your input sequence on protein fitness.
---
...
<Figure src="/_static/tools/poet/indel-nav.png" alt="Access the Tool using the Navigation Bar or prompt page" />
...
<Figure src="/_static/tools/poet/indel-fields.png" alt="Indel Input Fields" />
