...
description: "This tutorial teaches you how to use PoET's Substitution Analysis tool to score all single substitution variants of an input sequence with the given prompt."
---
...
<Figure src="/_static/tools/poet/substitution-analysis-input-prompt.png" alt="Substitution Analysis input and Prompt" />
...
<Figure src="/_static/tools/poet/filters-2.png" />
...
<Figure src="/_static/tools/poet/sub-analysis-1.png" alt="Substitution Analysis Heatmap" />
...
Now that you have a list of promising variants, use [Structure Prediction](/web-app/structure-prediction/using-structure-prediction) to visualize their structural implications or start a project using our [OP models](/web-app/opmodels) after acquiring data from your designs.
