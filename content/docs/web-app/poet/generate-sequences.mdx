...
description: This tutorial teaches you how to generate functional sequences conditioned on the sequence context provided by a prompt.
---
...
<Figure src="/_static/tools/poet/sampling-parameters.png" alt="Sampling Parameters" />
...
<Figure src="/_static/tools/poet/refolding-settings.png" alt="Refolding settings" />
...
Now that you can generate custom sequences, use the [Structure Prediction](/web-app/structure-prediction/using-structure-prediction) tool on high scoring sequences to visualize their structural implication or use [Substitution Analysis](/web-app/poet/substitution-analysis) to view possible improvements to a sequence.
