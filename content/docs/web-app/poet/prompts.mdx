...
description: A prompt is an input that directs a generative AI model to produce the desired protein sequences.
---
...
<Callout type="info">
PoET-1 is still available for some use cases and legacy workflows, but we recommend PoET-2 for most scenarios.
</Callout>
...
<Figure src="/_static/tools/poet/query-1.png" alt="Uploading query" />
...
<Figure src="/_static/tools/poet/query-2.png" alt="Sequence editor tools" />
...
<Figure src="/_static/tools/poet/prompt-context-use-existing-1.png" alt="Use existing prompt" />

<Figure src="/_static/tools/poet/prompt-context-use-existing-2.png" alt="Use existing prompt" />
...
<Figure src="/_static/tools/poet/prompt-context-custom-1.png" alt="Create custom context" />
...
<Figure src="/_static/tools/poet/prompt-context-custom-2.png" alt="Manage prompts" />
...
<Figure src="/_static/tools/poet/prompt-context-msa.png" alt="Manage prompts" />
...
<Figure src="/_static/tools/poet/prompt-1.png" alt="Uploading prompt without a project" />
...
<Figure src="/_static/tools/poet/prompt-2.png" alt="Uploading prompt from project" />

- **Left Sidebar:** Click the **Upload** button under the **Prompt** section and select your file.

<Figure src="/_static/tools/poet/prompt-3.png" alt="Uploading prompt within a project" />

<Figure src="/_static/tools/poet/prompt-4.png" alt="Uploaded prompt preview" />

- **From a MSA:** On an existing MSA page, click **Create Prompt**.

<Figure src="/_static/tools/poet/prompt-5.png" alt="Create prompt from MSA page" />
...
<Figure src="/_static/tools/poet/prompt-6-1.png" alt="Uploading MSA without a project" />

<Figure src="/_static/tools/poet/prompt-6-2.png" alt="Uploading MSA without a project" />
...
<Figure src="/_static/tools/poet/prompt-7.png" alt="Uploading MSA on project page" />

<Figure src="/_static/tools/poet/prompt-8.png" alt="Uploading MSA popup on project page" />

- **Left Sidebar**: Click the **Upload** button under the **MSA** section and input or upload a file.

<Figure src="/_static/tools/poet/prompt-9.png" alt="sidebar MSA upload button" />

<Figure src="/_static/tools/poet/prompt-10.png" alt="Uploading MSA popup within a project" />
...
<Figure src="/_static/tools/poet/prompt-11.png" alt="entering seed sequence without a project" />
...
<Figure src="/_static/tools/poet/prompt-12.png" alt="Uploading MSA on project page" />

- **Left Sidebar**: Click the **Upload** button under the **MSA** section, input a sequence, and click **Search for homologs to build MSA**.

<Figure src="/_static/tools/poet/prompt-9.png" alt="sidebar MSA upload button" />

<Figure src="/_static/tools/poet/prompt-13.png" alt="single seq popup sidebar" />
...
<Callout type="info">
Antibody prompts can't be edited or deleted the way a prompt of your own can. If you need a variation, for example a different sample size or clustering threshold, build a new prompt following the same reference database as a starting point, see Creating a Context below.
</Callout>

<Figure src="/_static/tools/poet/system-prompt-1.png" alt="system level prompts" />
