const predictorSpec = {
  ...
  "paths": {
      ...
      "get": {
        ...
        "parameters": [
          ...
          },
          {
            "name": "stats",
            "in": "query",
            "description": "Whether to include calibration stats in the metadata, using the latest crossvalidation.",
            "required": false,
            "schema": {
              "type": "boolean",
              "default": false
          ...
          },
          {
            ...
            "in": "query",
            "description": "Whether to include calibration curve in the metadata, using the latest crossvalidation.",
            "required": false,
            "schema": {
              "type": "boolean",
              "default": false
      ...
      "get": {
        ...
        "parameters": [
          ...
          },
          {
            ...
            "in": "query",
            "description": "Whether or not to return train graph for only a single measurement name.",
            "required": false,
            "schema": {
              "type": "string"
            }
          ...
          },
          {
            "name": "all_graphs",
            "in": "query",
            "description": "Whether or not to return all train graphs instead of only the best.",
            "required": false,
            "schema": {
              "type": "boolean",
              "default": false
        ...
        "responses": {
          "200": {
            "description": "Predictor details including train graphs if available.",
            "content": {
              "application/json": {
                "schema": {
    ...
    "/api/v1/predictor/crossvalidate/{job_id}": {
      "get": {
        ...
        "responses": {
          "200": {
            "description": "Crossvalidate results with evaluations encoded in csv format.",
            "content": {
              "application/octet-stream": {
                "schema": {
                  "type": "string",
                  "format": "binary",
                  "example": "row_index,sequence,measurement_name,y_mu,y_var\n1,MGHKL,measurement_1,0.123,0.456\n"
                }
              }
            }
          },
    ...
    "/api/v1/predictor/predict_single_site": {
      "post": {
        ...
        "description": "Run a single-site prediction using multiple trained predictor on a reference base sequence.",
    ...
    "/api/v1/predictor/predict/{job_id}/{sequence}": {
      "get": {
        ...
        "responses": {
          "200": {
            "description": "Prediction result in csv format. Format is `sequence,prop1_mu,prop1_var,prop2_mu,prop2_var,...`",
            "content": {
              "application/json": {
                "schema": {
                  "type": "string",
          ...
          "400": {
            "description": "Prediction result retrieval error. Contact support for assistance if persistent.",
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/Error"
    ...
    "/api/v1/predictor/predict/{job_id}": {
      "get": {
        ...
        "responses": {
          ...
          "400": {
            "description": "Prediction results retrieval error. Contact support for assistance if persistent.",
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/Error"
  ...
  "components": {
    ...
    "schemas": {
        ...
        "allOf": [
          {
            ...
            "properties": {
              "type": {
                "type": "string",
                "description": "Type of featurization method. `SVD` refers to a fitted SVD.",
                "enum": [
                  "1-HOT",
                  "PLM",
                  "SVD"
      ...
      "Kernel": {
        "title": "Kernel",
        "description": "Kernel used for training a kernel-based predictor, e.g. GP.",
        "type": "object",
        "required": [
          "type",
          "multitask"
        ...
        "properties": {
          ...
          "period": {
            "type": "number",
            "format": "double",
            "description": "Period length for the periodic kernel. Only valid when type is periodic.",
            "example": 1
          },
          "alpha": {
            "type": "number",
            "format": "double",
            "description": "Scale-mixture parameter for the rational_quadratic kernel; must be > 0. Only valid when type is rational_quadratic.",
            "example": 1
          }
        }
      },
      ...
      "Constraints": {
        ...
        "properties": {
          "sequence_length": {
            "description": "Possible constraint on fixed length sequence if no reduction was used to train.",
            "type": "integer",
            "example": 1024
          }
        }
      ...
      "CalibrationStats": {
        ...
        "properties": {
          "pearson": {
            "type": "number",
            "format": "float",
            "description": "Pearson correlation of the predictor's crossvalidation.",
            "nullable": true,
            "example": 0.123
          },
          "spearman": {
            "type": "number",
            "format": "float",
            "description": "Spearman correlation of the predictor's crossvalidation.",
            "nullable": true,
            "example": 0.248
          },
          "ece": {
            "type": "number",
            "format": "float",
            "description": "Calibration score of the predictor's crossvalidation.",
            "example": 0.456
          }
        }
      },
        ...
        "items": {
          ...
          "properties": {
            "x": {
              "type": "number",
              "format": "float",
              "description": "Predicted quantile for predictor's crossvalidation."
            },
            "y": {
              "type": "number",
              "format": "float",
      ...
      "BasePredictor": {
        "title": "Predictor",
        "description": "Predictor used to run predictions of properties on sequences.",
        "type": "object",
        "required": [
          "id",
          "name",
      ...
      "TrainGraph": {
        "title": "TrainGraph",
        "description": "Train graph representing the loss curves for a train job.",
        "type": "object",
        "required": [
          "losses"
        ],
        "properties": {
          "measurement_name": {
            "type": "string",
            "description": "Measurement name that was trained for this curve. Empty or null if multitask.",
            "x-order": 1
          },
      ...
      "PredictSingleSiteRequest": {
        ...
        "description": "Request to run single site predictions using a trained predictor.",
        "type": "object",
        "required": [
          "base_sequence"
        ],
  ...
  "tags": [
    {
      "name": "predictor",
      "description": "Train and use predictor to predict properties for your sequences"
    }
  ]
};
